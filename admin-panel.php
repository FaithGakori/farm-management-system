...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="" aria-hidden="true"></i> Smart Farm Management System</a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #008000, #00c6ff);
}
               ...
               <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Price Prediction</h4>
                        
                      <p class="links cl-effect-1">
                        <a href={{ url_for('price_prediction') }}>
                          Price Prediction
                        </a>
                      </p>
                    </div>
